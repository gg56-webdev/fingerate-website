...
회사는 제6조에서 정한 사항을 정확히 기재한 이용자에 대하여 서비스 이용 신청을 승낙합니다.
...
회사는 포인트 및 회원 등급 부여의 기준 등에 관련된 세부이용지침을 별도로 정하여 시행할 수 있습니다.
...
회사는 회원의 개인정보 보호를 위해 보안시스템을 구축하며 개인정보 보호정책을 공시하고 준수합니다.
